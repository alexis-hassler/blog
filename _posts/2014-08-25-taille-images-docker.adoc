...
La semaine dernière, j'ai publié un billet sur la mise en place d'un link:/2014/08/18/cluster-wildfly-avec-docker.html[cluster WildFly avec Docker]. 
Une des premières réactions est venue de link:https://hypedrivendev.wordpress.com/[Cédric Exbrayat] pour me donner quelques conseils pour link:https://web.archive.org/web/20140810214606/http://www.centurylinklabs.com/optimizing-docker-images/?hvid=1OW0br[réduire la taille de mes images].
...
Enfin, j'ai testé l'utilisation de plusieurs images de base, dont BusyBox, comme me l'a suggéré link:https://dduportal.github.io[Damien Duportal].
// <!--more-->

== Taille des images

J'ai construit mes deux images avec des Dockerfiles. 
Chaque Dockerfile est une séquence de link:https://docs.docker.com/reference/dockerfile/[commandes ADD, COPY, RUN,...]. 
...
On arrive à un résultat similaire à la construction directe d'une image de base, suggérée par link:https://www.linkedin.com/in/hguemar/[Haïkel Guémar].
