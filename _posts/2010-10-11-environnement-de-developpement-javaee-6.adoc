...
Pour avoir des bons guest add-ons, il faut utiliser ceux des dépôts d'Ubuntu comme expliqué link:https://www.sysprobs.com/maverick-meerkat-ubuntu-1010-virtualbox-328-ubuntu-1010-guest-additions-fix[ici]. 
...
Il ne me reste plus qu'à ouvrir le livre d'link:https://www.antoniogoncalves.org[Antonio Goncalves], complété de quelques exemples d'link:https://www.adam-bien.com/[Adam Bien] et à coder...
