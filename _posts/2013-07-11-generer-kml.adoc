...
Dans mon article précédent, j'expliquais comment j'avais obtenu des link:/2013/07/09/du-sig-google-maps.html[coordonnées géographiques à partir de coordonnées Lambert 93]. 
...
Le premier abord est bien meilleur que pour proj4j : https://mvnrepository.com/artifact/de.micromata.jak/JavaAPIforKml[artefact dans le repository central de Maven] et https://web.archive.org/web/20130708003354/http://labs.micromata.de/display/jak/Home[un peu de doc]. 
