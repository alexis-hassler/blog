...
Et tout ça parce que j'avais mal lu la link:https://logback.qos.ch/manual[documentation].

L'histoire a commencé quand j'ai voulu ajouter l'adresse IP des clients de mon application Web dans les logs.
J'avais déjà configuré mon link:https://logback.qos.ch/manual/mdc.html#mis[MDCInsertingServletFilter], il ne me restait qu'à utiliser ses informations.
